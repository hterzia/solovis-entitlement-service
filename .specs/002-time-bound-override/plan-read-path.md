...
**Date**: 2026-08-10 (settled) · **Status: complete — built and merged to `main`.** The earlier draft that kept a service-side holder for the feed is superseded; the decision and its alternatives are recorded in this document.
