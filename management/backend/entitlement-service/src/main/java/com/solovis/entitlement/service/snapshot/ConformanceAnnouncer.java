...
public class ConformanceAnnouncer {
    ...
    public Optional<Long> announceIfChanged() {
        ...
        // The model is untouched; only the version advances, because a delta is only transportable
        // as a snapshot_version row. Replicas apply it by replacing their vector set and re-gating;
        // no decision changes.
